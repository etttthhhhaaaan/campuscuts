  ...
  return (
    <div className="flex flex-row justify-center items-start overflow-hidden">
      ...
      <div className="w-full md:w-1/2 mx-auto text-center md:text-left lg:p-20">
            ...
            <h1 className="text-4xl font-mono text-gray-300 my-2">
      ...
      <div className="hidden lg:block relative w-full md:w-1/2 -mr-40 mt-20">
        <div className="w-3/4 ">
          ...
          <img src={userData.avatarUrl} alt="ethansPic" className=" shadow" />
          ...
          <div className="flex flex-row justify-between mt-4">
            <div className="flex flex-row space-x-4 text-white">
              ...
              <p className="font-mono text-white">Our storefront!</p>
            </div>
          </div>
        </div>
      </div>
